...
function get_main_danhmuc()
    ...
    $sql="select * from table_news_danhmuc where type='".$type."' order by stt";
...
function get_main_list()
    ...
    $sql="select * from table_news_list where id_danhmuc=".$id_danhmuc."  order by stt";
		$stmt=mysql_query($sql);
		$str='
...
function get_main_category()
    ...
    $sql="select * from table_news_cat where id_list=".$id_list." order by stt";
		$stmt=mysql_query($sql);
		$str='
...
function get_main_item()
    ...
    $sql_huyen="select * from table_news_item where id_cat=".$id_cat." order by id desc ";
...
<form name="supplier" id="validate" class="form" action="index.php?com=news&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <?php if($_GET['type']=='nangluongmattroi'||$_GET['type']=='giaiphap'||$_GET['type']=='duan'||$_GET['type']=='tintuc') { ?>
        <div class="formRow">
        ...
        <div class="formRow">
			...
			<div class="formRight">
                ...
                <?php  } ?>
                 ...
                 <?php if($_GET['type']=='giaiphap'||$_GET['type']=='nangluongmattroi'||$_GET['type']=='chamsockhachhang') { ?>
                <div class="note"> Width:400px | Height:250px<?=_format_duoihinh_l?> </div>
                <?php   }  ?>
